/**
 * Cada premio tiene un nombre, un número de tickets necesarios para conseguir 
 * ese premio y un recuento o stock de los elementos de esta categoría que están 
 * asignados a un terminal. Los premios no saben a qué terminal pertenecen.
 */
package Objetos;
